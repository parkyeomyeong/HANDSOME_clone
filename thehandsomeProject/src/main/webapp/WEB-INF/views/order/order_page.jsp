							...
							<tbody>
								<tr>
									...
									<td>
										...
										</div> <input value="" title="주소2" name="address2" id="address2"
										...
										<div class="input_sumtxt">
											<div class="input_sumtxt_box">
												...
												<input onkeyup="chkword('omessage','omessage_text_length',20);"
													...
													maxlength="20"> <!-- onclick="documents.getElementByClassName('delivery').focus()" -->
												<!-- //input --><!-- autocomplete="off" --> 
												 <div class="delivery_comt" style="display: none;">
													<ul>
														<li><a href="javascript:void(0);" name="deliveryrequestmessages" data-readonly="readonly"
															value="배송 전 연락 바랍니다"> 배송 전 연락 바랍니다</a></li>
														<li style="background: rgb(248, 248, 248);" ><a
															href="javascript:void(0);"  name="deliveryrequestmessages" data-readonly="readonly"
														...
														<li><a href="javascript:void(0);"  name="deliveryrequestmessages" data-readonly="readonly"
															value="부재 시 핸드폰으로 연락바랍니다"> 부재 시
																핸드폰으로 연락바랍니다</a></li>
														<li style="background: rgb(248, 248, 248);"><a
															href="javascript:void(0);"  name="deliveryrequestmessages" data-readonly="write"
										...
										<!-- <div class="ckout_wrap" id="ckout_wrap0" style="">
											<div class="oclk_card_list_wrap" id="oclk_card_list_wrap">
													...
													<ul class="swiper-wrapper"
														...
														<li class="swiper-slide swiper-slide-active"
															...
															<div class="card_item cd_kind_add">
																<a href="#none" class="card_add_btn" id="btnCardRegist">카드등록</a>
															</div>
														</li>
													</ul>
												</div>
												<a href="#;"
													...
													style="display: none;">이전</a> <a href="#;"
				...
				<div class="float_right"
					...
					<div class="p_a_box">
						<div class="point">
							...
							<p class="txt" id="txtAccumulationPoint">한섬마일리지 ${realMilege}
							</p>
							<p class="txt" id="txtAccumulationHPoint">H.Point 
								${realTotalPoint}</p>
							<!-- 간편회원이 아닐 때  e -->
							<input type="hidden" name="accumulationPoint"
								id="accumulationPoint" value="22500"> <input
								type="hidden" name="accumulationHPoint" id="accumulationHPoint"
								value="450">
						</div>
