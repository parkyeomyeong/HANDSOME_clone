...
<div id="bodyWrap" class="products">
	...
	<div class="adaptive_wrap">
		<form id="categoryListForm" action="/ko/c/categoryList">
			...
			<div class="filterWrap hsDelivery1902">
				<ul class="clearfix float_left">
					...
					<li class="brand" id="brand_li_btn"><a
						href="javascript:void(0);" class="select">브랜드 <span
							class="current" id="brandCurrent"> <span class="ico_arr">arrow</span>
						</span>
					...
					<li class="color" id="color_li_btn"><a
						...
						<div class="list list_item4" id="color_list_li"
							...
							<ul class="color_chip clearfix" id="category_color_chip">
								...
								<li class="mr0"><a href="javascript:void(0);"
								...
								<li><a href="javascript:void(0);" class="wt"
					...
					<li class="price" id="price_li_btn"><a
						href="javascript:void(0);" class="select">가격<span
							class="ico_arr">arrow</span></a>
						<div class="list" id="price_list_li" style="display: none;">
							<ul>
								<li><input type="checkbox" id="price_ck" value="1">
									<label for="price_ck1" id="lable_ck1"> ￦100,000 이하</label></li>
								<li><input type="checkbox" id="price_ck" value="2">
									<label for="price_ck2" id="lable_ck2">￦100,000 ~
										￦300,000</label></li>
								<li><input type="checkbox" id="price_ck" value="3">
									<label for="price_ck3" id="lable_ck3">￦300,000 ~
										￦500,000</label></li>
								<li><input type="checkbox" id="price_ck" value="4">
									<label for="price_ck4" id="lable_ck4">￦500,000 ~
										￦1,000,000</label></li>
								<li><input type="checkbox" id="price_ck" value="5">
					...
					<li class="sortby" id="sortby_li_btn"><a
						...
						<div class="list" id="sortby_list_li" style="display: none;">
							<ul>
								<li id="new"><a href="javascript:void(0);" value="1"
									name="order_a">신상품</a></li>
								<li id="most"><a href="javascript:void(0);" value="2"
									name="order_a">판매순</a></li>
								<li id="max"><a href="javascript:void(0);" value="3"
									name="order_a">고가순</a></li>
								<li id="min"><a href="javascript:void(0);" value="4"
					...
					<li class="btn"><a id="resetapp" href="javascript:void(0);">초기화</a><a
						id="filterapp" href="javascript:void(0);">적용</a></li>
		...
		<form id='actionForm' action="/product/list" method='get'>
			<input type='hidden' name='ctg' value='${ctg}'> <input
